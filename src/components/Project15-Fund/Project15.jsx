    ...
    <div className={styles.container}>
      <div className={styles.floatleft} style={{ marginBottom: "3em" }}>
        ...
        <p className={styles.text}>
          The head of marketing of the Swiss company SSUG approached me for this
          project in which I should develop in a short period of time the
          identity, website, corporate branding manual and a presentation of the
          company, the final goal: to have in less than a month absolutely all
          the necessary material to give the GO to the company.
        </p>
        <div
        ...
        >
          <Button
            name="Visit Website"
            link="https://www.ssugflagshipfund.com/"
          />
        </div>
      </div>
    </div>
        ...
        <section className={styles.contentlogo}>
          ...
          <div className={styles.right}>
            ...
            >
              ...
              Minimalist, simple, noble were the fundamental bases for the
              creation of this logo. I decided to add features similar to the
              SSUG logo while maintaining a new, fresh and a pleasing identity.
            </p>
          </div>
        </section>
      </div>
    ...
    <div className={styles.container}>
      <section className={styles.flexfifty} style={{ marginTop: "2em" }}>
        <div className={styles.flexleft}>
          ...
          <p className={styles.text}>
            After digital sketching 5 concepts and the final feedback of the
            client, I proceeded to develop the logo together with the creation
            of the brand guidelines and website.
          </p>
        </div>
