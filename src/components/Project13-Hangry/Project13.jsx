  ...
  <div>
        ...
        <section className={styles.contentlogo}>
          ...
          <div className={styles.right}>
            ...
            >
              ...
              The project was about creating the identity of the website/app
              were people had the possibility of locating a restaurant, place an
              orders, pay and setup pickup time and order tracking. In the same
              way restaurants had the chance to register, administrate their
              profile, manage their content, orders, payments and analytics.
            </p>
          </div>
        </section>
      </div>
    ...
    <div className={styles.container}>
      ...
      <section className={styles.content} style={{ marginTop: "4em" }}>
        ...
        >
          <p className={styles.text}>
            At the first stage we focus on developing the logo, branding, tone
            and color palette for further testing before developing the
            wireframe and UI of the app.
          </p>
        </div>
      </section>
      ...
      <div className="tc" style={{ marginTop: "4em", marginBottom: "4em" }}>
        ...
        >
          After researching the market, mood and tendencies, decided to sketch 3
          concepts together with Logo, color palettes and logotypes.
        </h3>
      </div>
    </div>
    <div>
    ...
    <div className={styles.container}>
      <div className="tc" style={{ marginTop: "4em", marginBottom: "4em" }}>
        <h3
          ...
          style={{ textAlign: "center", paddingBottom: "1em" }}
        >
          The three concepts were tested on Usability Hub to be able to reach
          the final election.
        </h3>
        <h3
          className={styles.h3text}
