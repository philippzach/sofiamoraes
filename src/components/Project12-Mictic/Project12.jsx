...
const Project2 = () => (
  <div>
    ...
    <div
      ...
      style={{ backgroundColor: "white", padding: "3em 2em 2em 2em" }}
    >
      <div className={styles.container}>
        <section className={styles.contentlogo}>
          ...
          <div className={styles.right}>
            ...
            >
              <h2 style={{ fontWeight: "400", paddingBottom: "1em" }}>
                The problem/goal:
              </h2>
              The client approached me with the simple goal of building an easy
              jet consumer driven website to identify the product, its primary
              usage, and lead the user into future pre-orders.
            </p>
          </div>
        </section>
      </div>
    ...
    <div className={styles.container}>
      ...
      <div className="tc" style={{ marginTop: "4em", marginBottom: "4em" }}>
        <h3
          className={styles.h3text}
          style={{ textAlign: "center", paddingBottom: "1em" }}
        >
          The main challenge in terms of design was to show the user in a
          concise way and within the first seconds of opening the site what the
    ...
    <div className={styles.container}>
      <div className="tc" style={{ marginTop: "4em", marginBottom: "4em" }}>
        <h3
          ...
          style={{ textAlign: "center", paddingBottom: "1em" }}
        >
          Being a completely new product in our world and our daily life, we
          decided to use the most direct and impressive communication system on
          the page: videos! also incorporate a nice fluid design to invite the
          user to learn more about the product. Used graphics and photos to
          further encourage the experience and reward.
        </h3>
      </div>
    </div>
    <div>
